...
const bot9 = new Bot(process.env.BOT_TOKEN_9, {
    polling: true,
});
...
bot9.on("polling_error", console.log);


console.log("Bot started");

setupBot(bot1, "LAB Support");
console.log("LAB Support started");

setupBot(bot2, "Moonbeam Support");
console.log("Moonbeam Support started");

setupBot(bot3, "BelDex Support");
console.log("BelDex Support started");

setupBot(bot4, "Secondfi Support");
console.log("Secondfi Support started");

setupBot(bot5, "Pepeto Support");
console.log("Pepeto Support started");

setupBot(bot6, "Blockdag Support");
console.log("Blockdag Support started");

setupBot(bot7, "Midnight Network Support");
console.log("Midnight Network Support started");

setupBot(bot8, "BTCHyper Support");
console.log("BTCHyper Support started");

setupBot(bot9, "Harmony Protocol Support");
console.log("Harmony Protocol Support started");
