...
setupBot(bot1, "Moonbeam Support");
console.log("Moonbeam Support started");

setupBot(bot2, "Secondfi Support");
...
setupBot(bot5, "Coldcard Support");
...
setupBot(bot8, "Vanarchain Support");
console.log("Vanarchain Support started");
